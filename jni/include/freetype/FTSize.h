...
#include <jni.h>
/* Header for class generaloss_freetype_freetype_FTSize */

#ifndef _Included_generaloss_freetype_freetype_FTSize
#define _Included_generaloss_freetype_freetype_FTSize
#ifdef __cplusplus
extern "C" {
#endif
/*
